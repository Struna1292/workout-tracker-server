...
import { loginLimiter, emailLimiter } from '../middlewares/rateLimiter.js';
import { 
    login, 
    register, 
    refreshToken, 
...
router.get('/verify-email', [authToken, loadUser, emailLimiter], getEmailVerificationCode);

// verify email with code
router.post('/verify-email', [checkBody, authToken, loadUser], verifyEmail);

// get e-mail with code to reset password
router.post('/forgot-password', [checkBody, emailLimiter], getForgotPasswordCode);
